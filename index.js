...
const yargs = require("yargs").version(false).scriptName("person");
...
.usage(`$0 [command] [subcommand] [arguments]`)
    ...
    .command(`address [operation]`,
        `Address related operations. For more details see examples or use "${yargs.$0} address --help"`, (yargs)=>{
            yargs.help() .options({
                help: {
                  alias: 'h',
                  describe: 'help',
            ...
            .check((yargs)=>{
                ...
                if(yargs.operation != "add" &&yargs.operation != "edit" &&yargs.operation != "delete" ){
                    throw (new Error(`Only add/edit/delete operation is allowed for address.`));
                }
                if(yargs.operation=="add" && yargs.pid != undefined && yargs.l1 != undefined){
                    return true;
                }
                else if(yargs.operation =="add" ) {
                    if (yargs.pid == undefined || yargs.l1 == undefined)
                ...
                if(yargs.i != undefined && (yargs.l1 != undefined||yargs.l2 !=undefined || yargs.ctr !=undefined || yargs.pc != undefined)){
                    ...
                    throw (new Error(`Id and atleast one option (line1/line2/country/postcode) is required while editing an address`));
                }
            }
    ...
    .example(`$0 add --firstname "Bob" --lastname "Smith" --dob 10/03/1960`, `Creates a new person record with mandatory parameters first name as "Bob", last name as "Smith" and date of birth as "10/03/1960".\n`)
    .example(`$0 add --firstname "Susan" --lastname "Delgato" --dob 01/05/1970 --nickname "Susie"`, `Creates a new person record with mandatory parameters first name as "Susan", last name as "Delgato", date of birth as "01/05/1971" and an optional parameter nickname as "Susie".\n`)
    .example(`$0 edit --id 3 --lastname "Patel"`, `Edits the last name of a person with id 3 to "Patel"".\n`)
    .example(`$0 delete --id 3`, `Deletes a person having person id as 3.\n`)
    ...
    .example(`$0 address add --personId 3 --line1 "123 Evergreen Terrace" --country "Denmark"`, `Adds address of the person having person id as 3 and mandatory parameter as line1.\n`)
    .example(`$0 address edit --id 9 --line2 "Strand"`, `Updates line2 of address having address id as 9.\n`)
    .example(`$0 address delete --id 9`, `Deletes an address with address id as 9.\n`)
    .wrap(120)
    .recommendCommands()
    .epilogue(`For option alias and other details, type "${yargs.$0} [argument] --help", example $0 add --help`)
    // .help()
